...
using TicketBlazorApp.Client.Pages;
using TicketBlazorApp.Components;
using TicketBlazorApp.Components.Account;
...
app.MapRazorComponents<App>()
    ...
    .AddAdditionalAssemblies(typeof(TicketBlazorApp.Client._Imports).Assembly);
